    ...
    <div class="twitter-advanced-settings">
      <div class="space-y-3">
        <form phx-change="update_setting" phx-target={@myself}>
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Who can reply</label>
            <select
          ...
          <div class="mt-3">
            <label class="flex items-center">
              ...
              />
              <span class="ml-2 text-sm text-gray-600 dark:text-gray-300">Add location to tweet</span>
            </label>
          </div>

          <div class="mt-3">
            <label class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Image alt text</label>
            <input
              type="text"
              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
            ...
            />
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Make your images accessible</p>
          </div>
          ...
          <div class="mt-3">
            <label class="flex items-center">
              ...
              />
              <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Mark as sensitive content</span>
            </label>
          </div>
        </form>
      </div>
