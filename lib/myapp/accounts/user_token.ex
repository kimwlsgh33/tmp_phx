defmodule Myapp.Accounts.UserToken do
  ...
  * "confirm" - Used for verifying a user's email address (valid for 7 days)
  * "reset_password" - Used for password reset flows (valid for 1 day for security)
  * "change:*" - Used when changing a user's email address (valid for 7 days)
  ...
  * **Email tokens** (for confirmation, password reset, etc.) are stored as hashed values
  ...
  ## Token Lifecycle
  1. **Creation** - Tokens are generated using strong random bytes (32 bytes)
